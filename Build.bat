...
set CommonCompilerFlags=-F4194304 -MT -nologo -Gm- -GR- -EHa- -fp:fast -Od -Oi -WX -W4 -wd4324 -wd4505 -wd4456 -wd4457 -wd4063 -wd4702 -wd4201 -wd4100 -wd4189 -wd4459 -wd4127 -wd4311 -wd4302 -wd4366 -FC -Z7 
set CommonCompilerFlags=-D_CRT_SECURE_NO_WARNINGS -DNOMINMAX -DWIN32_LEAN_AND_MEAN -DVC_EXTRALEAN %CommonCompilerFlags%
set CommonCompilerFlags=-DENGINE_RELEASE %CommonCompilerFlags%
